...
See [`denoise-ai-models.md`](denoise-ai-models.md) for detailed comparison. Licensing in [`denoise-ai-LICENSES.md`](denoise-ai-LICENSES.md).
...
- **Licensing:** all three models are commercial-safe (MIT / BSD-3 / Apache 2.0). No caveats. See [`denoise-ai-LICENSES.md`](denoise-ai-LICENSES.md).
...
- [`denoise-ai-models.md`](denoise-ai-models.md) — detailed per-model comparison (quality, speed, dereverb, BWE, known failure modes, real-world recipes).
- [`denoise-ai-LICENSES.md`](denoise-ai-LICENSES.md) — strict confirmation that all three models are commercial-safe.
