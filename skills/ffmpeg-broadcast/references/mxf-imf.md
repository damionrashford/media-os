# MXF / IMF / ProRes / XDCAM / SMPTE Timecode (broadcast & film delivery)
...
See `references/mxf-imf-formats.md` for full codec profile tables.
...
- Read [`references/mxf-imf-formats.md`](mxf-imf-formats.md) for MXF operational patterns, DNxHD/DNxHR profiles, ProRes profiles, XDCAM variants, timecode syntax, IMF spec refs, Netflix/Disney/Apple delivery notes, external IMF tooling, SMPTE 2022/2110 overview, and DeckLink SDI capture.
