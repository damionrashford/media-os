...
description: Use when the user expresses ANY media-production intent — go live / stream / OBS / NDI / DeckLink / PTZ, HLS / DASH / CMAF / DRM package, CDN upload, MXF / IMF / ProRes / AS-11 / Netflix broadcast deliver, OTIO / FCPXML / EDL / AAF conform, AI upscale / interpolate / denoise / matte / depth, generate image / video / TTS / music, podcast master / loudness, VFX / EXR / ACES / OCIO / USD, Dolby Vision / HDR10+ / tone-map / PQ↔HLG, VOD encode / x264 / x265 / VMAF gate, QC / freeze / black / loudness check, audio routing / mix (PipeWire / JACK / Core Audio / MIDI / OSC), ingest / probe / archive / hash-verify, DSLR tether. ALWAYS route media intent through this skill — do NOT hand-roll ffmpeg or answer media-production questions in the main thread; it composes modes/_shared.md + modes/{mode}.md and spawns the right specialist. Skip ONLY when editing the system itself or a one-off single-ffprobe lookup.
---
