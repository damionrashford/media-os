# 360° / VR and Stereoscopic 3D Video

Source skill: `ffmpeg-360-3d`. Triggers: convert 360 video projections, equirectangular to cubemap, unwrap fisheye, convert side-by-side 3D to top-bottom, make anaglyph 3D, reproject 360 video, handle VR180/VR360 content. Filters: v360 (equirectangular, cubemap 3x2/6x1/1x6, fisheye, flat, hequirect, dfisheye, cylindrical, perspective, barrel, sinusoidal, half_equirectangular, stereographic, mercator, ball, hammer, pannini, eac, c3x2/c6x1/c1x6, rfish), stereo3d (SBS ↔ TAB ↔ interlaced ↔ anaglyph), framepack.
...
- Read [`360-3d-projections.md`](360-3d-projections.md) for the full v360 type table, stereo3d code table, framepack options, and VR platform compatibility matrix.
