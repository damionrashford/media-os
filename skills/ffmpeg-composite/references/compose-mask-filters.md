...
For dedicated green-screen workflows see `chromakey.md` (and `chromakey-filters.md`) in this skill; this combo is for when you need pixel-exact edge control the keyer can't give you.
