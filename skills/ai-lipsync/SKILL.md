...
```bash
uv run .claude/skills/ai-lipsync/scripts/lipsync.py install liveportrait
# prints:
...
uv run .claude/skills/ai-lipsync/scripts/lipsync.py install latentsync
# prints:
...
```bash
uv run .claude/skills/ai-lipsync/scripts/lipsync.py check
```
