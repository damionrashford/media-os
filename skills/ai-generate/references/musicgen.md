...
Full license audit (including excluded models and Stable Audio's $1M ARR cap) in [`references/musicgen-LICENSES.md`](musicgen-LICENSES.md).
...
- **License boundary with Stable Audio Open:** the Stability AI Community License permits commercial use **only up to $1M in cumulative revenue**. Above that you need a commercial agreement with Stability. Riffusion and YuE have no such cap. Flag this early to the user. See [`references/musicgen-LICENSES.md`](musicgen-LICENSES.md).
...
- [`references/musicgen-LICENSES.md`](musicgen-LICENSES.md) — strict confirmation of commercial-safety, including Stable Audio Open's $1M ARR cap and explicit exclusions of MusicGen / Suno / Udio / Jukebox.
