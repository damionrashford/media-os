# Inverse Telecine / Deinterlace / Frame-Rate (formerly ffmpeg-ivtc)
...
Deep option tables for every filter below live in [`references/ivtc-filters.md`](ivtc-filters.md).
