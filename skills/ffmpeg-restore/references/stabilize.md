# Stabilization (formerly ffmpeg-stabilize)
...
- Read [`references/vidstab.md`](vidstab.md) for full option tables, tripod mode, recipe gallery, and the build-from-source note.
