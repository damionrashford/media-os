...
See `references/whip-protocol.md` for per-platform auth details.
...
- Read [`references/whip-protocol.md`](whip-protocol.md) for the WHIP handshake, per-platform URL patterns, auth schemes, and RTMP/HLS comparison.
