...
If you just need HLS, DASH, RTMP, SRT, or RTSP — use the `streaming.md` reference. If you need WebRTC (WHIP) — use the `whip.md` reference.
...
- Read [`references/advproto.md`](advproto.md) for RIST profile comparison, URL option catalog, ZMQ command API, prompeg FEC math, latency comparison, and recipe book.
