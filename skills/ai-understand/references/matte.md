...
- Per-model URLs, license, benchmarks, GPU/CPU notes → `references/matte-models.md`.
- Full license table — including the v1.4 vs. v2.0 RMBG distinction and GPL-3.0 RVM implications → `references/matte-LICENSES.md`.
