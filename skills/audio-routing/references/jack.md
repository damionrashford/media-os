...
See [`references/backends.md`](backends.md) for per-backend flag quirks.
...
See [`references/jacktrip.md`](jacktrip.md) for hub mode, FEC, and
...
- Per-backend driver flag catalog (ALSA, CoreAudio, PortAudio, ASIO) →
  [`references/backends.md`](backends.md).
- JackTrip server/client/hub mode, FEC, port list →
  [`references/jacktrip.md`](jacktrip.md).
