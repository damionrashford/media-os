...
Read [`references/exclusive-vs-shared.md`](exclusive-vs-shared.md)
when the user asks about latency, bit-perfect playback, or
`IAudioClient::Initialize` errors.
Read [`references/virtual-cable.md`](virtual-cable.md) when the user
...
- **`svcl.exe /SetDefault "<Name>" Playback`** — NirSoft command-line version
  of SoundVolumeView. See [`references/virtual-cable.md`](virtual-cable.md)
  for full `svcl` flags.
...
[`references/exclusive-vs-shared.md`](exclusive-vs-shared.md) for
...
[`references/virtual-cable.md`](virtual-cable.md) for a worked
routing example.
...
- Shared-mode vs exclusive-mode deep dive, latency tradeoffs, IAudioClient3 →
  [`references/exclusive-vs-shared.md`](exclusive-vs-shared.md).
- VB-Cable tiers, `svcl.exe` flag reference, VoiceMeeter routing examples →
  [`references/virtual-cable.md`](virtual-cable.md).
