...
This section is **docs only**. For actual capability (running `pw-link`, installing
BlackHole, flipping Windows default output), use the technique references in this
same skill: `pipewire.md`, `jack.md`, `coreaudio.md`, `wasapi.md`.
...
Read [`references/pages.md`](pages.md) when you need the full catalog
