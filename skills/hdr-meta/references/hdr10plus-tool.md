...
- For Dolby Vision (NOT HDR10+), use `references/dovi-tool.md`.
- For doc lookup, use `references/docs-search.md`.
...
Latest at time of writing: **1.7.2 (Dec 2025)**, MSRV **Rust 1.85.0**. Check current: docs-search `fetch --page hdr10plus-releases`.
...
- Verified hdr10plus_tool subcommand catalog → `references/subcommands.md`.
