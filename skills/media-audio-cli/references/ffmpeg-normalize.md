...
Rule of thumb: **broadcast = -23 LUFS, podcast = -16 LUFS, streaming = -14 LUFS**. See `references/normalize-catalog.md` for the full platform table.
...
- Read [`references/normalize-catalog.md`](normalize-catalog.md) for the platform target table, LUFS/dBFS/LRA concepts, raw-loudnorm vs wrapper comparison, and recipe book.
