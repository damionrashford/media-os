...
Type `/` to browse the 96 skills, or ask Claude to do something media-related ("convert this HDR clip to SDR", "build a HLS ABR ladder", "restore this VHS rip with open-source AI"). Skills auto-load.
